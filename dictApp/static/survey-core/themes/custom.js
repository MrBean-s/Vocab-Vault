...
/* Mainly survey-core theme: contract-dark.js  with a few colors modified */

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
  typeof define === 'function' && define.amd ? define(factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.SurveyTheme = global.SurveyTheme || {}, global.SurveyTheme.ContrastDark = factory()));
  ...
  var contrastDark = {
    ...
    "cssVariables": {
      ...
      "--sjs2-color-utility-body": "var(--bg-body)",
      ...
      "--sjs2-color-utility-surface-survey": "var(--bg-body)",
      ...
      "--sjs2-color-utility-shadow-floating-default": "rgba(from var(--bg-surface) r g b / var(--sjs2-opacity-x060))",

      "--sjs2-color-bg-basic-primary": "var(--bg-surface)",
      "--sjs2-color-bg-basic-secondary": "var(--sjs2-palette-gray-850)",

      "--sjs2-color-bg-basic-tertiary": "var(--bg-elevated)",
      ...
      "--sjs2-color-border-basic-secondary": "var(--border-color)",
      ...
      "--sjs2-color-component-panel-simple-default-bg": "var(--bg-surface)",
      "--sjs2-color-component-radio-false-default-bg": "var(--bg-elevated)",
      "--sjs2-color-component-radio-false-hovered-bg": "var(--text-muted-darker)",
      "--sjs2-color-component-action-brand-tertiary-surface-default-bg": "var(--bg-purple)",
      "--sjs2-color-component-action-brand-tertiary-surface-hovered-bg": "var(--accent-purple)",
      "--sjs2-color-component-action-brand-tertiary-surface-default-label": "var(--text-main)",
      "--sjs2-color-component-action-brand-tertiary-surface-hovered-label": "var(--text-main)",

      "--sjs2-color-component-formbox-default-bg": "var(--bg-elevated)",
      "--sjs2-color-bg-basic-secondary": "var(--bg-elevated)",
    }
  };

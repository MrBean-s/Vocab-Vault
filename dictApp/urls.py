...
urlpatterns = [
   ...
   path("lang/<int:lang_id>/word/<int:word_id>/relation/<int:rel_word_id>", views.word_relation, name="word_relation"),
   path("lang/<int:lang_id>/word/<int:word_id>/relation/<int:rel_word_id>/confirm-unlink/", views.confirm_unlink, name="confirm_unlink"),
